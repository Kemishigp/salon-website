    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-6">
      <div className="w-full max-w-md space-y-12">
        ...
        <form onSubmit={handleRegister} className="space-y-10">
          ...
          type="button"
          className='text-white border border-white/20  rounded-full justify-center items-center flex py-4 w-full font-sans uppercase text-xs font-bold tracking-[0.2em] hover:bg-white hover:text-black'
          >
